        ...
        <div class="card-body">
            ...
            <form wire:submit="update">
                ...
                <div class="mb-3">
                    ...
                    <select id="brand_id" wire:model="brand_id" class="form-select">
                ...
                <div class="mb-3">
                    ...
                    <input id="description" wire:model="description" class="form-control">
                ...
                <div class="mb-3">
                    ...
                    <input id="low_stock_alert" wire:model="low_stock_alert" class="form-control">
                    @error('low_stock_alert') <small class="text-danger">{{ $message }}</small> @enderror
                </div>
